...
class ZMCircleAnimation:UIView {
    ...
    public var circleProperties:ZMCircleProperties = ZMCircleProperties(backgroundColor: UIColor.red, circleColor: UIColor.blue)
    
    /// - Total percent
    public var percent = 100
    
    /// - Initial value text
    public var initialValue = 0
